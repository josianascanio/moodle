# Moodle MCP Artifacts

Artefactos listos para instalar al replicar la configuracion MCP.
...
- `roles/cursomcp.xml`: rol exportado con permisos MCP para importar en Moodle.

Ver `../README_MCP_MOODLE.md` para el procedimiento completo.
